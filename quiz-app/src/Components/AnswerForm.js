...
class AnswerForm extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    this.props.correct_answer.includes(this.userAnswer)
      ? this.props.incrementScore(this.props.players[this.props.turnCount].name)
    ...
    if (
      this.props.round < 4 &&
      this.props.turnCount === this.props.players.length - 1
    ) {
